    ...
    <x-admin-layout>
        <div class="w-full max-w-full mx-auto px-12 my-8 md:my-24">
            ...
            <div class="w-full flex justify-start mt-8 md:justify-end mb-8">
                <a href="{{route('admin.galeri.create')}}" class="btn btn-primary btn-sm">Tambah Foto</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($galeri as $item)
                            <tr>
                                ...
                                <td>
                                    <button class="btn h-24" onclick="modal_{{$item->id}}.showModal()">
                                        <div class="w-16 h-10 md:w-28 md:h-16" style="background-image: url('{{asset($item->foto)}}'); background-size: cover; background-position: center"></div>
                                    </button>
                                </td>
                            ...
                            <dialog id="modal_{{$item->id}}" class="modal">
                                <div class="modal-box">
                                    <div class="w-full h-56" style="background-image: url('{{asset($item->foto)}}') ; background-position: center; background-size: cover"></div>
